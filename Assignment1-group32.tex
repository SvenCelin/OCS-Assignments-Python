...
$$
 \sum_{i=0}^{15} ( c_i x_i) \le 9 \quad\quad\quad\quad\quad\quad \text{(1)}
$$
$$
\sum_{i=16}^{30} ( c_i x_i) \le 6 \quad\quad\quad\quad\quad\quad \text{(2)}
$$
...
Inequality constraints are the eq. (1,2). Equality constraint is $x_i + x_{i+15} = 0$ because any one task can only be done by one student.
\\ \\
Solution:
